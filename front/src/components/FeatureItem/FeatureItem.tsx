...
const FeatureItem: React.FC<any> = ({ showDependency = true, onTaskOpen = () => {}, ...feature }) => {
    ...
    <Accordion onChange={handleChange()}>
      ...
      <AccordionDetails className="p-0">
        <div className="flex flex-col gap-2 m-2 justify-center items-center">
          ...
          {tasks?.map((task, key) => (
            <div className="flex-1 bg-blue-300 rounded-md px-3 py-1" key={key} onClick={() => handleTaskOpen(task.id)}>
